...
void * AddValidationException(void *msgId);
void * Application_Init(void *app, void *inst);
void * Buffer_CopyFrom(void *buffer, void *offset, void *ptr, void *size);
...
void * Command_ClearImage(void *cmd, void *dst, void *imRange, void *layout, void *color, void *alpha);
...
void * GraphicsPipeline_SetTopology(void *pl, void *topology);
...
void * NewDesktop(void *app, void *imageUsage, void *desktop);
void * NewImageLoader(void *loader);
void * NewRenderPass(void *dev, void *rp, void *depthAttachment, void *attachments, void *attachments_len);
...
void * RenderPass_NewNullFrameBuffer(void *rp, void *width, void *height, void *fb);
...
func call_AddDynamicDescriptors(ctx APIContext, app hApplication) {
	...
	rc := uintptr(C.AddDynamicDescriptors(unsafe.Pointer(uintptr(app))))
	handleError(ctx, rc)
}
func call_AddValidation(ctx APIContext, app hApplication) {
	...
	rc := uintptr(C.AddValidation(unsafe.Pointer(uintptr(app))))
	handleError(ctx, rc)
}
func call_AddValidationException(ctx APIContext, msgId int32) {
	...
	rc := uintptr(C.AddValidationException(unsafe.Pointer(uintptr(msgId))))
	handleError(ctx, rc)
}
func call_Application_Init(ctx APIContext, app hApplication, inst *hInstance) {
	...
	rc := uintptr(C.Application_Init(unsafe.Pointer(uintptr(app)), unsafe.Pointer(inst)))
	handleError(ctx, rc)
}
func call_Buffer_CopyFrom(ctx APIContext, buffer hBuffer, offset uint64, ptr uintptr, size uint64) {
	...
	rc := uintptr(C.Buffer_CopyFrom(unsafe.Pointer(uintptr(buffer)), unsafe.Pointer(uintptr(offset)), unsafe.Pointer(uintptr(ptr)), unsafe.Pointer(uintptr(size))))
	handleError(ctx, rc)
}
func call_Buffer_GetPtr(ctx APIContext, buffer hBuffer, ptr *uintptr) {
	...
	rc := uintptr(C.Buffer_GetPtr(unsafe.Pointer(uintptr(buffer)), unsafe.Pointer(ptr)))
	handleError(ctx, rc)
}
func call_Buffer_NewView(ctx APIContext, buffer hBuffer, format Format, offset uint64, size uint64, view *hBufferView) {
	...
	rc := uintptr(C.Buffer_NewView(unsafe.Pointer(uintptr(buffer)), unsafe.Pointer(uintptr(format)), unsafe.Pointer(uintptr(offset)), unsafe.Pointer(uintptr(size)), unsafe.Pointer(view)))
	handleError(ctx, rc)
}
func call_Command_Begin(ctx APIContext, cmd hCommand) {
	...
	rc := uintptr(C.Command_Begin(unsafe.Pointer(uintptr(cmd))))
	handleError(ctx, rc)
}
func call_Command_BeginRenderPass(ctx APIContext, cmd hCommand, rp hRenderPass, fb hFramebuffer) {
	...
	rc := uintptr(C.Command_BeginRenderPass(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(rp)), unsafe.Pointer(uintptr(fb))))
	handleError(ctx, rc)
}
func call_Command_ClearImage(ctx APIContext, cmd hCommand, dst hImage, imRange *ImageRange, layout ImageLayout, color float32, alpha float32) {
	...
	rc := uintptr(C.Command_ClearImage(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(dst)), unsafe.Pointer(imRange), unsafe.Pointer(uintptr(layout)), unsafe.Pointer(uintptr(color)), unsafe.Pointer(uintptr(alpha))))
	handleError(ctx, rc)
}
func call_Command_Compute(ctx APIContext, hCmd hCommand, hPl hComputePipeline, x uint32, y uint32, z uint32, descriptors []hDescriptorSet) {
	...
	rc := uintptr(C.Command_Compute(unsafe.Pointer(uintptr(hCmd)), unsafe.Pointer(uintptr(hPl)), unsafe.Pointer(uintptr(x)), unsafe.Pointer(uintptr(y)), unsafe.Pointer(uintptr(z)), unsafe.Pointer(sliceToUintptr(descriptors)), unsafe.Pointer(uintptr(len(descriptors)))))
	handleError(ctx, rc)
}
func call_Command_CopyBuffer(ctx APIContext, cmd hCommand, src hBuffer, dst hBuffer) {
	...
	rc := uintptr(C.Command_CopyBuffer(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(src)), unsafe.Pointer(uintptr(dst))))
	handleError(ctx, rc)
}
func call_Command_CopyBufferToImage(ctx APIContext, cmd hCommand, src hBuffer, dst hImage, imRange *ImageRange, offset uint64) {
	...
	rc := uintptr(C.Command_CopyBufferToImage(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(src)), unsafe.Pointer(uintptr(dst)), unsafe.Pointer(imRange), unsafe.Pointer(uintptr(offset))))
	handleError(ctx, rc)
}
func call_Command_CopyImageToBuffer(ctx APIContext, cmd hCommand, src hImage, dst hBuffer, imRange *ImageRange, offset uint64) {
	...
	rc := uintptr(C.Command_CopyImageToBuffer(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(src)), unsafe.Pointer(uintptr(dst)), unsafe.Pointer(imRange), unsafe.Pointer(uintptr(offset))))
	handleError(ctx, rc)
}
func call_Command_Draw(ctx APIContext, cmd hCommand, draws []DrawItem) {
	...
	rc := uintptr(C.Command_Draw(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(sliceToUintptr(draws)), unsafe.Pointer(uintptr(len(draws)))))
	handleError(ctx, rc)
}
func call_Command_EndRenderPass(ctx APIContext, cmd hCommand) {
	...
	rc := uintptr(C.Command_EndRenderPass(unsafe.Pointer(uintptr(cmd))))
	handleError(ctx, rc)
}
func call_Command_SetLayout(ctx APIContext, cmd hCommand, image hImage, imRange *ImageRange, newLayout ImageLayout) {
	...
	rc := uintptr(C.Command_SetLayout(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(image)), unsafe.Pointer(imRange), unsafe.Pointer(uintptr(newLayout))))
	handleError(ctx, rc)
}
func call_Command_Wait(ctx APIContext, cmd hCommand) {
	...
	rc := uintptr(C.Command_Wait(unsafe.Pointer(uintptr(cmd))))
	handleError(ctx, rc)
}
func call_Command_WriteTimer(ctx APIContext, cmd hCommand, qp hQueryPool, stages PipelineStageFlags, timerIndex uint32) {
	...
	rc := uintptr(C.Command_WriteTimer(unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(qp)), unsafe.Pointer(uintptr(stages)), unsafe.Pointer(uintptr(timerIndex))))
	handleError(ctx, rc)
}
func call_ComputePipeline_Create(ctx APIContext, cp hComputePipeline) {
	...
	rc := uintptr(C.ComputePipeline_Create(unsafe.Pointer(uintptr(cp))))
	handleError(ctx, rc)
}
...
func call_DescriptorLayout_NewPool(ctx APIContext, layout hDescriptorLayout, size uint32, pool *hDescriptorPool) {
	...
	rc := uintptr(C.DescriptorLayout_NewPool(unsafe.Pointer(uintptr(layout)), unsafe.Pointer(uintptr(size)), unsafe.Pointer(pool)))
	handleError(ctx, rc)
}
func call_DescriptorPool_Alloc(ctx APIContext, pool hDescriptorPool, ds *hDescriptorSet) {
	...
	rc := uintptr(C.DescriptorPool_Alloc(unsafe.Pointer(uintptr(pool)), unsafe.Pointer(ds)))
	handleError(ctx, rc)
}
func call_DescriptorSet_WriteBuffer(ctx APIContext, ds hDescriptorSet, binding uint32, at uint32, buffer hBuffer, from uint64, size uint64) {
	...
	rc := uintptr(C.DescriptorSet_WriteBuffer(unsafe.Pointer(uintptr(ds)), unsafe.Pointer(uintptr(binding)), unsafe.Pointer(uintptr(at)), unsafe.Pointer(uintptr(buffer)), unsafe.Pointer(uintptr(from)), unsafe.Pointer(uintptr(size))))
	handleError(ctx, rc)
}
func call_DescriptorSet_WriteBufferView(ctx APIContext, ds hDescriptorSet, binding uint32, at uint32, bufferView hBufferView) {
	...
	rc := uintptr(C.DescriptorSet_WriteBufferView(unsafe.Pointer(uintptr(ds)), unsafe.Pointer(uintptr(binding)), unsafe.Pointer(uintptr(at)), unsafe.Pointer(uintptr(bufferView))))
	handleError(ctx, rc)
}
func call_DescriptorSet_WriteImage(ctx APIContext, ds hDescriptorSet, binding uint32, at uint32, view hImageView, sampler hSampler) {
	...
	rc := uintptr(C.DescriptorSet_WriteImage(unsafe.Pointer(uintptr(ds)), unsafe.Pointer(uintptr(binding)), unsafe.Pointer(uintptr(at)), unsafe.Pointer(uintptr(view)), unsafe.Pointer(uintptr(sampler))))
	handleError(ctx, rc)
}
func call_Desktop_CreateWindow(ctx APIContext, desktop hDesktop, title []byte, pos *WindowPos, win *hWindow) {
	...
	rc := uintptr(C.Desktop_CreateWindow(unsafe.Pointer(uintptr(desktop)), unsafe.Pointer(byteArrayToUintptr(title)), unsafe.Pointer(uintptr(len(title))), unsafe.Pointer(pos), unsafe.Pointer(win)))
	handleError(ctx, rc)
}
func call_Desktop_GetKeyName(ctx APIContext, desktop hDesktop, keyCode uint32, name []uint8, strLen *uint32) {
	...
	rc := uintptr(C.Desktop_GetKeyName(unsafe.Pointer(uintptr(desktop)), unsafe.Pointer(uintptr(keyCode)), unsafe.Pointer(sliceToUintptr(name)), unsafe.Pointer(uintptr(len(name))), unsafe.Pointer(strLen)))
	handleError(ctx, rc)
}
func call_Desktop_GetMonitor(ctx APIContext, desktop hDesktop, monitor uint32, info *WindowPos) {
	...
	rc := uintptr(C.Desktop_GetMonitor(unsafe.Pointer(uintptr(desktop)), unsafe.Pointer(uintptr(monitor)), unsafe.Pointer(info)))
	handleError(ctx, rc)
}
func call_Desktop_PullEvent(ctx APIContext, desktop hDesktop, ev *RawEvent) {
	...
	rc := uintptr(C.Desktop_PullEvent(unsafe.Pointer(uintptr(desktop)), unsafe.Pointer(ev)))
	handleError(ctx, rc)
}
func call_Device_NewBuffer(ctx APIContext, dev hDevice, size uint64, hostMemory bool, usage BufferUsageFlags, buffer *hBuffer) {
	...
	rc := uintptr(C.Device_NewBuffer(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(size)), unsafe.Pointer(boolToUintptr(hostMemory)), unsafe.Pointer(uintptr(usage)), unsafe.Pointer(buffer)))
	handleError(ctx, rc)
}
func call_Device_NewCommand(ctx APIContext, dev hDevice, queueType QueueFlags, once bool, command *hCommand) {
	...
	rc := uintptr(C.Device_NewCommand(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(queueType)), unsafe.Pointer(boolToUintptr(once)), unsafe.Pointer(command)))
	handleError(ctx, rc)
}
func call_Device_NewComputePipeline(ctx APIContext, dev hDevice, cp *hComputePipeline) {
	...
	rc := uintptr(C.Device_NewComputePipeline(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(cp)))
	handleError(ctx, rc)
}
func call_Device_NewDescriptorLayout(ctx APIContext, dev hDevice, descriptorType DescriptorType, stages ShaderStageFlags, element uint32, flags DescriptorBindingFlagBitsEXT, prevLayout hDescriptorLayout, dsLayout *hDescriptorLayout) {
	...
	rc := uintptr(C.Device_NewDescriptorLayout(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(descriptorType)), unsafe.Pointer(uintptr(stages)), unsafe.Pointer(uintptr(element)), unsafe.Pointer(uintptr(flags)), unsafe.Pointer(uintptr(prevLayout)), unsafe.Pointer(dsLayout)))
	handleError(ctx, rc)
}
func call_Device_NewGraphicsPipeline(ctx APIContext, dev hDevice, gp *hGraphicsPipeline) {
	...
	rc := uintptr(C.Device_NewGraphicsPipeline(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(gp)))
	handleError(ctx, rc)
}
func call_Device_NewImage(ctx APIContext, dev hDevice, usage ImageUsageFlags, desc *ImageDescription, image *hImage) {
	...
	rc := uintptr(C.Device_NewImage(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(usage)), unsafe.Pointer(desc), unsafe.Pointer(image)))
	handleError(ctx, rc)
}
func call_Device_NewMemoryBlock(ctx APIContext, dev hDevice, memBlock *hMemoryBlock) {
	...
	rc := uintptr(C.Device_NewMemoryBlock(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(memBlock)))
	handleError(ctx, rc)
}
func call_Device_NewSampler(ctx APIContext, dev hDevice, repeatMode SamplerAddressMode, sampler *hSampler) {
	...
	rc := uintptr(C.Device_NewSampler(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(repeatMode)), unsafe.Pointer(sampler)))
	handleError(ctx, rc)
}
func call_Device_NewTimestampQuery(ctx APIContext, dev hDevice, size uint32, qp *hQueryPool) {
	...
	rc := uintptr(C.Device_NewTimestampQuery(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(size)), unsafe.Pointer(qp)))
	handleError(ctx, rc)
}
func call_Device_Submit(ctx APIContext, dev hDevice, cmd hCommand, priority uint32, info []hSubmitInfo, waitStage PipelineStageFlags, waitInfo *hSubmitInfo) {
	...
	rc := uintptr(C.Device_Submit(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(uintptr(cmd)), unsafe.Pointer(uintptr(priority)), unsafe.Pointer(sliceToUintptr(info)), unsafe.Pointer(uintptr(len(info))), unsafe.Pointer(uintptr(waitStage)), unsafe.Pointer(waitInfo)))
	handleError(ctx, rc)
}
...
func call_GraphicsPipeline_AddAlphaBlend(ctx APIContext, pl hGraphicsPipeline) {
	...
	rc := uintptr(C.GraphicsPipeline_AddAlphaBlend(unsafe.Pointer(uintptr(pl))))
	handleError(ctx, rc)
}
func call_GraphicsPipeline_AddDepth(ctx APIContext, pl hGraphicsPipeline, write bool, check bool) {
	...
	rc := uintptr(C.GraphicsPipeline_AddDepth(unsafe.Pointer(uintptr(pl)), unsafe.Pointer(boolToUintptr(write)), unsafe.Pointer(boolToUintptr(check))))
	handleError(ctx, rc)
}
func call_GraphicsPipeline_AddVertexBinding(ctx APIContext, pl hGraphicsPipeline, stride uint32, rate VertexInputRate) {
	...
	rc := uintptr(C.GraphicsPipeline_AddVertexBinding(unsafe.Pointer(uintptr(pl)), unsafe.Pointer(uintptr(stride)), unsafe.Pointer(uintptr(rate))))
	handleError(ctx, rc)
}
func call_GraphicsPipeline_AddVertexFormat(ctx APIContext, pl hGraphicsPipeline, format Format, offset uint32) {
	...
	rc := uintptr(C.GraphicsPipeline_AddVertexFormat(unsafe.Pointer(uintptr(pl)), unsafe.Pointer(uintptr(format)), unsafe.Pointer(uintptr(offset))))
	handleError(ctx, rc)
}
func call_GraphicsPipeline_Create(ctx APIContext, pipeline hGraphicsPipeline, renderPass hRenderPass) {
	...
	rc := uintptr(C.GraphicsPipeline_Create(unsafe.Pointer(uintptr(pipeline)), unsafe.Pointer(uintptr(renderPass))))
	handleError(ctx, rc)
}
func call_GraphicsPipeline_SetTopology(ctx APIContext, pl hGraphicsPipeline, topology PrimitiveTopology) {
	...
	rc := uintptr(C.GraphicsPipeline_SetTopology(unsafe.Pointer(uintptr(pl)), unsafe.Pointer(uintptr(topology))))
	handleError(ctx, rc)
}
func call_ImageLoader_Describe(ctx APIContext, loader hImageLoader, kind []byte, desc *ImageDescription, content []uint8) {
	...
	rc := uintptr(C.ImageLoader_Describe(unsafe.Pointer(uintptr(loader)), unsafe.Pointer(byteArrayToUintptr(kind)), unsafe.Pointer(uintptr(len(kind))), unsafe.Pointer(desc), unsafe.Pointer(sliceToUintptr(content)), unsafe.Pointer(uintptr(len(content)))))
	handleError(ctx, rc)
}
func call_ImageLoader_Load(ctx APIContext, loader hImageLoader, kind []byte, content []uint8, buf hBuffer) {
	...
	rc := uintptr(C.ImageLoader_Load(unsafe.Pointer(uintptr(loader)), unsafe.Pointer(byteArrayToUintptr(kind)), unsafe.Pointer(uintptr(len(kind))), unsafe.Pointer(sliceToUintptr(content)), unsafe.Pointer(uintptr(len(content))), unsafe.Pointer(uintptr(buf))))
	handleError(ctx, rc)
}
func call_ImageLoader_Save(ctx APIContext, loader hImageLoader, kind []byte, desc *ImageDescription, buf hBuffer, content []uint8, reqSize *uint64) {
	...
	rc := uintptr(C.ImageLoader_Save(unsafe.Pointer(uintptr(loader)), unsafe.Pointer(byteArrayToUintptr(kind)), unsafe.Pointer(uintptr(len(kind))), unsafe.Pointer(desc), unsafe.Pointer(uintptr(buf)), unsafe.Pointer(sliceToUintptr(content)), unsafe.Pointer(uintptr(len(content))), unsafe.Pointer(reqSize)))
	handleError(ctx, rc)
}
func call_ImageLoader_Supported(ctx APIContext, loader hImageLoader, kind []byte, read *bool, write *bool) {
	...
	rc := uintptr(C.ImageLoader_Supported(unsafe.Pointer(uintptr(loader)), unsafe.Pointer(byteArrayToUintptr(kind)), unsafe.Pointer(uintptr(len(kind))), unsafe.Pointer(read), unsafe.Pointer(write)))
	handleError(ctx, rc)
}
func call_Image_NewView(ctx APIContext, image hImage, imRange *ImageRange, imageView *hImageView, cube bool) {
	...
	rc := uintptr(C.Image_NewView(unsafe.Pointer(uintptr(image)), unsafe.Pointer(imRange), unsafe.Pointer(imageView), unsafe.Pointer(boolToUintptr(cube))))
	handleError(ctx, rc)
}
func call_Instance_GetPhysicalDevice(ctx APIContext, instance hInstance, index int32, info *DeviceInfo) {
	...
	rc := uintptr(C.Instance_GetPhysicalDevice(unsafe.Pointer(uintptr(instance)), unsafe.Pointer(uintptr(index)), unsafe.Pointer(info)))
	handleError(ctx, rc)
}
func call_Instance_NewDevice(ctx APIContext, instance hInstance, index int32, pd *hDevice) {
	...
	rc := uintptr(C.Instance_NewDevice(unsafe.Pointer(uintptr(instance)), unsafe.Pointer(uintptr(index)), unsafe.Pointer(pd)))
	handleError(ctx, rc)
}
func call_MemoryBlock_Allocate(ctx APIContext, memBlock hMemoryBlock) {
	...
	rc := uintptr(C.MemoryBlock_Allocate(unsafe.Pointer(uintptr(memBlock))))
	handleError(ctx, rc)
}
func call_MemoryBlock_Reserve(ctx APIContext, memBlock hMemoryBlock, memObject hMemoryObject, suitable *bool) {
	...
	rc := uintptr(C.MemoryBlock_Reserve(unsafe.Pointer(uintptr(memBlock)), unsafe.Pointer(uintptr(memObject)), unsafe.Pointer(suitable)))
	handleError(ctx, rc)
}
func call_NewApplication(ctx APIContext, name []byte, app *hApplication) {
	...
	rc := uintptr(C.NewApplication(unsafe.Pointer(byteArrayToUintptr(name)), unsafe.Pointer(uintptr(len(name))), unsafe.Pointer(app)))
	handleError(ctx, rc)
}
func call_NewDesktop(ctx APIContext, app hApplication, imageUsage ImageUsageFlags, desktop *hDesktop) {
	...
	rc := uintptr(C.NewDesktop(unsafe.Pointer(uintptr(app)), unsafe.Pointer(uintptr(imageUsage)), unsafe.Pointer(desktop)))
	handleError(ctx, rc)
}
func call_NewImageLoader(ctx APIContext, loader *hImageLoader) {
	...
	rc := uintptr(C.NewImageLoader(unsafe.Pointer(loader)))
	handleError(ctx, rc)
}
func call_NewRenderPass(ctx APIContext, dev hDevice, rp *hRenderPass, depthAttachment bool, attachments []AttachmentInfo) {
	...
	rc := uintptr(C.NewRenderPass(unsafe.Pointer(uintptr(dev)), unsafe.Pointer(rp), unsafe.Pointer(boolToUintptr(depthAttachment)), unsafe.Pointer(sliceToUintptr(attachments)), unsafe.Pointer(uintptr(len(attachments)))))
	handleError(ctx, rc)
}
func call_Pipeline_AddDescriptorLayout(ctx APIContext, pl hPipeline, dsLayout hDescriptorLayout) {
	...
	rc := uintptr(C.Pipeline_AddDescriptorLayout(unsafe.Pointer(uintptr(pl)), unsafe.Pointer(uintptr(dsLayout))))
	handleError(ctx, rc)
}
func call_Pipeline_AddShader(ctx APIContext, pl hPipeline, stage ShaderStageFlags, code []uint8) {
	...
	rc := uintptr(C.Pipeline_AddShader(unsafe.Pointer(uintptr(pl)), unsafe.Pointer(uintptr(stage)), unsafe.Pointer(sliceToUintptr(code)), unsafe.Pointer(uintptr(len(code)))))
	handleError(ctx, rc)
}
func call_QueryPool_Get(ctx APIContext, qp hQueryPool, values []uint64, timestampPeriod *float32) {
	...
	rc := uintptr(C.QueryPool_Get(unsafe.Pointer(uintptr(qp)), unsafe.Pointer(sliceToUintptr(values)), unsafe.Pointer(uintptr(len(values))), unsafe.Pointer(timestampPeriod)))
	handleError(ctx, rc)
}
func call_RenderPass_NewFrameBuffer(ctx APIContext, rp hRenderPass, attachments []hImageView, fb *hFramebuffer) {
	...
	rc := uintptr(C.RenderPass_NewFrameBuffer(unsafe.Pointer(uintptr(rp)), unsafe.Pointer(sliceToUintptr(attachments)), unsafe.Pointer(uintptr(len(attachments))), unsafe.Pointer(fb)))
	handleError(ctx, rc)
}
func call_RenderPass_NewNullFrameBuffer(ctx APIContext, rp hRenderPass, width uint32, height uint32, fb *hFramebuffer) {
	...
	rc := uintptr(C.RenderPass_NewNullFrameBuffer(unsafe.Pointer(uintptr(rp)), unsafe.Pointer(uintptr(width)), unsafe.Pointer(uintptr(height)), unsafe.Pointer(fb)))
	handleError(ctx, rc)
}
func call_Window_GetNextFrame(ctx APIContext, win hWindow, image *hImage, submitInfo *hSubmitInfo, viewIndex *int32) {
	...
	rc := uintptr(C.Window_GetNextFrame(unsafe.Pointer(uintptr(win)), unsafe.Pointer(image), unsafe.Pointer(submitInfo), unsafe.Pointer(viewIndex)))
	handleError(ctx, rc)
}
func call_Window_GetPos(ctx APIContext, win hWindow, pos *WindowPos) {
	...
	rc := uintptr(C.Window_GetPos(unsafe.Pointer(uintptr(win)), unsafe.Pointer(pos)))
	handleError(ctx, rc)
}
func call_Window_PrepareSwapchain(ctx APIContext, win hWindow, dev hDevice, imageDesc *ImageDescription, imageCount *int32) {
	...
	rc := uintptr(C.Window_PrepareSwapchain(unsafe.Pointer(uintptr(win)), unsafe.Pointer(uintptr(dev)), unsafe.Pointer(imageDesc), unsafe.Pointer(imageCount)))
	handleError(ctx, rc)
}
func call_Window_SetPos(ctx APIContext, win hWindow, pos *WindowPos) {
	...
	rc := uintptr(C.Window_SetPos(unsafe.Pointer(uintptr(win)), unsafe.Pointer(pos)))
	handleError(ctx, rc)
}
